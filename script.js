...
function createNewContainer() {
  ...
  newContainer.innerHTML = `
    ...
    <button class="img container" onclick="openFileInput('fileInput${count}')">
      ...
      <input type="file" name="fileInput${count}" id="fileInput${count}" capture="gallery" accept="image/*" style="display: none;" onchange="previewImage('fileInput${count}', 'imagePreview${count}')" />
